...
export const products: Product[] = [
   ...
   */
  {
    ...
    metadata: {
      ...
      description:
        "Optimize your power infrastructure with the SMC-Server Station Management Controller. Ideal for grid energy storage and renewable energy systems.",
    },
  },
];

export function sortProductsBySlug<T extends { slug: string }>(
  items: readonly T[],
): T[] {
