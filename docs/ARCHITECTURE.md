...
2. `public/js/contact-form.js` validates required fields in the browser, applies a 15-second request timeout, and posts JSON with the locale, page URL, and submission timestamp.
